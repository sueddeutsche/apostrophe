...
module.exports = function(self) {
  ...
  self._getData = function(data) {
    ...
    code += _.map(data, function(datum) {
        // this is just a temp fix, because this fails while trying to merge 'mediaLibrary' with apos.data
        if(datum.mediaLibrary) {
            return '  $.extend(true, apos.data, ' + "{ 'mediaLibrary': {} }" + ');';
        }
