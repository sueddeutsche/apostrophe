...
module.exports = function(self, options) {
  ...
  self.createRoutes = function() {
    ...
    self.route('post', 'choices', self.routes.choices);
  };
  ...
  self.routes.manage = function(req, res) {
    ...
    return res.send(self.render(req, 'manage', { options: self.options, choose: req.body.choose, schema: self.schema }));
  };
  ...
  self.routes.choices = function(req, res) {
    // Must do at least some validation rather than trusting this, TODO:
    // memos of actual schemas in the user's session would be better
    var field = _.pick(req.body.field, 'idField', 'idsField', 'relationshipsField', 'relationshipField', 'relationships', 'name', 'type');
